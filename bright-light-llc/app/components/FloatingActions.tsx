  ...
  return (
    <>
      ...
      <div className="fixed bottom-3 sm:bottom-4 right-2 sm:right-3 md:right-4 z-50 flex flex-col gap-2.5 sm:gap-3 md:gap-4">
        ...
        <a
          href="https://wa.me/971543078535?text=Hello!%20I%20want%20to%20know%20more%20about%20your%20products.%20Please%20share%20details.%20Thanks"
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300"
          title="Chat on WhatsApp"
          aria-label="WhatsApp"
        >
          <svg viewBox="0 0 448 512" fill="currentColor" className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white">
